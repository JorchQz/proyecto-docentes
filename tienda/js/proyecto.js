...
document.addEventListener("DOMContentLoaded", async function () {
	...
	// ── Vista previa: PDF recortado de ESTE proyecto ───────────────────────────
	// Las imágenes de previews/ son del grado (compartidas por el paquete); aquí
	// conviene la muestra del proyecto concreto, que es lo que se compra.
